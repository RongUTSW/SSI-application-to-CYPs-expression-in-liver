...
## -------------------- work of 06/26/2019 starts from this line:
## need to re-create Figure 2 to meet reviewer #4's major points "4. Figure 2. The figure is not very clear. The lines are too faint and the lettering too small. ..."

## step 1: change line color to black:
E(Danxin.net.2)$color <- "black"
plot(Danxin.net.2)

## step 2: need to search for random seed value to replicate the layout in current Figure 2
# i <- 0
# while(i==0){
#   rs <- sample(1:10000,1)
#   print(rs)
#   set.seed(rs)
#   plot(Danxin.net.2)
#   i <- as.integer(readline("input a number != 0 if you'd like to stop"))
#   if(i!=0){
#     pdf(paste("./random_seed_scan_06262019/Rplot_",rs,".pdf",sep=""), 30, 30)
#     set.seed(rs)
#     plot(Danxin.net.2)
#     dev.off()
#   }
...
## random seed: 4765 and 7425 produce most similar layout:
pdf("Figure2_4765.pdf",29,29)
set.seed(4765)
plot(Danxin.net.2)
dev.off()
## -------------------- work of 06/26/2019 ends by this line.